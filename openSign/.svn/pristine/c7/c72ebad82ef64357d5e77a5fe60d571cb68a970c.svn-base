...
<div id="edu_box01" class="tab_cont tab_content">
	<div id="frt_print">
			...
			<table class="board_row_type01">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="">
							${orderVO.gender eq 'M' ? '남자' : orderVO.gender eq 'F' ? '여자' : '-' }
						</td>
					</tr>
					<tr>
						<th scope="row"><strong>생년월일</strong></th>
						<td colspan="">
							${fn:split(orderVO.juminno, '-')[0] }년 ${fn:split(orderVO.juminno, '-')[1] }월 ${fn:split(orderVO.juminno, '-')[2] }일
						</td>
						<th scope="row"><strong>휴대전화</strong></th>
						<td colspan="">
							<span class="tel">${orderVO.tel }</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3">
							[${orderVO.post }] ${orderVO.addr1 } ${orderVO.addr2 }
						</td>
					</tr>
					<tr>
						...
						<td colspan="">
							${orderVO.completeStatus eq 'Y' ? '수료' : orderVO.completeStatus eq 'N' ? '미수료' : '-' }
						</td>
					</tr>
		...
		<h3 class="md_tit03">직장/학교 정보</h3>
	       <!--tbl_wrap-->
		<div class="tbl_wrap">
			<table class="board_row_type01">
				<caption></caption>
				<colgroup>
					<col class="pc_w18p m_w20p">
					<col class="pc_w32p m_w30p">
					<col class="pc_w18p m_w20p">
					<col class="pc_w32p m_w30p">
				</colgroup> 
				<tbody>
					<tr>
						<th scope="row"><strong>회사명 (학교명)</strong></th>
						<td colspan="3">
							${orderVO.busiName }
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="">
							<span class="tel">${orderVO.telo }</span>
						</td>
						<th scope="row"><strong>회사 팩스번호</strong></th>
						<td colspan="">
							<span class="tel">${orderVO.fax }</span>
						</td>
					</tr>
					<tr>
						<th scope="row"><strong>주소</strong></th>
						<td colspan="3">
							[${orderVO.busiPost }] ${orderVO.busiAddr1 } ${orderVO.busiAddr2 }
						</td>
					</tr>
					<tr>
	...
	<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" onsubmit="return false;">
...
function fncPayAciton(ordernumber,typeChk){
	$("#btn_xpay").off("click");
