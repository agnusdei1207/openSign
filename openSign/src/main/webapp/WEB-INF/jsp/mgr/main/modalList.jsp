				...
				<fieldset>                 
					...
					<div class="search_basic">          
						...
						<span class="search_btns">  
							<button type="button" class="btn btn_search" onclick="fncPageEtc('popList','/mgr/statistics/modalAddList.do','1');">검색</button>
						</span>     
					</div>            
				</fieldset>           
			</form>         
...
$(function(){                            
	...
	fncPageEtc("popList", "/mgr/statistics/modalAddList.do", '1'); 
	return false;                 
});         
