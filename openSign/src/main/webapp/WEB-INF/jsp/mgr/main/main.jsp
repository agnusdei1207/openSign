						...
						<div class="state01 m_box" style="width: 634px;">   
							<h2 class="m_title" style="margin-bottom: 17px;">행정 현황</h2>
								<div class="search_basic" style="padding:0px 0px 0px;"> 
									...
									<select name="excelDivn" id="excelDivn"> 
										<option value="">전체</option>							   
										<option value="eat">식대</option>							   
										<option value="overTime">초과근무</option>							
									</select>                   
									<strong class="tit">년</strong> 
									...
									<a href="javascript:void(0)" class="btn btn_excel btn_sml03" onclick="excelDown();" style="margin-left:134px;"><span>엑셀 다운로드</span></a>
								</div>
